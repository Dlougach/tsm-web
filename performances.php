    ...
    <body>
        ...
        <div id="mainsection">
            ...
            <table id="showstable">
                ...
                <tr style="border-width: 0px">
                    <td colspan="6" align="center"> <!-- style="border-bottom-width: 2px; border-bottom-style: solid; border-bottom-color: #666666" -->
                        <img style="max-width: 100%; width: 700px; margin-bottom: 10px;" src="posters/poster-2013-december-24.jpg"/>
                    </td>
                </tr>
                <tr>
                    <td>4 апреля 2014&nbsp;г.</td>
                    <td>19:00</td>
                    <td><u>Микадо, или Город Титипу Салливан-гала</u></td>
                    <td>ДК МГУ &mdash; Большой&nbsp;зал</td>
                    <td> <a target="_blank" href="http://maps.yandex.ru/-/CVVeQM2x">Карта</a></td>
                    <td> <a target="_blank" href="posters/poster-2014-april-4.pdf">Афиша</a></td>
                </tr>
                <tr style="border-width: 0px">
                    <td colspan="6" align="center"> <!-- style="border-bottom-width: 2px; border-bottom-style: solid; border-bottom-color: #666666" -->
                        <img style="max-width: 100%; width: 700px; margin-bottom: 10px;" src="posters/poster-2014-april-4.jpg"/>
                    </td>
                </tr>
